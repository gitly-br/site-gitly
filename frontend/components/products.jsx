...
const Products = () => {
  return (
    <div className="bg-[#001D09] mx-auto flex flex-col py-10 px-4 md:px-14 md:flex-row items-center justify-between" style={{ background: 'linear-gradient(to right, #021b09, black)', color: 'white' }}>
      <div className="w-full md:w-1/4 flex flex-col md:items-left mb-8 text-white">
        ...
        <p className="text-lg mb-8 font-text">Oferecemos uma linha de produtos inovadores baseados em inteligência artificial, projetados para otimizar operações empresariais e melhorar a tomada de decisões. Nossas soluções abrangem desde análise de dados até automação de processos, todas com interfaces intuitivas e de fácil implementação.</p>
      </div>
