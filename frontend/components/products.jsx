...
const Products = () => {
  return (
    <div className="bg-[#001D09] mx-auto flex flex-col py-10 px-14 md:flex-row items-center justify-between" style={{ background: 'linear-gradient(to right, #021b09, black)', color: 'white' }}>
