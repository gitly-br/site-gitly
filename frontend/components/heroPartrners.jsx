...
const HeroPartners = () => {
    return (
        <div className = "bg-black flex flex-col text-center justify-center items-center sm:text-center py-40">
            ...
            Descubra Nossas Criações de Orgulho
            </p>
            <h1 className = 'font-title text-[6svw] md:text-[3svw] text-white mb-10 leading-tight'>Explore Nosso Mundo: Veja como nossas<br />inovações estão moldando o futuro</h1>
