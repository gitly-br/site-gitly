...
const LatestWork = () => {
  return (
    <div className="py-10 px-20 text-center flex flex-col bg-gradient-to-r from-[#021b09] to-black text-white paizao">
      ...
      <div className='flex flex-wrap justify-center items-center gap-5 md:flex-nowrap container'>
        <div className='relative flex w-full h-full md:w-1/2'>
          <Image className='w-full h-full' src={latest1} alt="latest1" />
        ...
        <div className='flex flex-col gap-5 w-full h-full lg:w-1/2'>
          ...
          <div className='flex flex-col md:flex-row object-cover w-full h-1/2'>
            <div className='bg-[#202020] rounded-xl flex flex-col md:flex-row text-wrap text-start md:pl-5 py- w-full h-full items-center'>
              ...
              <Image className='object-cover w-full md:w-1/2 h-full' src={latest3} alt="latest2" />
            </div>
          </div>
        </div>
      </div>
